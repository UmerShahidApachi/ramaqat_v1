        ...
        <div class="carousel-inner" role="listbox">
            ...
            @foreach($slider as $slide)
                <div class="carousel-item">
                    <!--Mask color-->
                    <div class="view">
                        <img class="d-block w-100" src="{{url('slider/').'/'.$slide['image']}}" alt="Second slide">
    ...
    <!--/.Carousel Wrapper-->
        ...
        <div class="container mt-3 mb-3">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active " id="{{$categories1->name}}-tab" data-toggle="tab" href="#{{$categories1->name}}" role="tab"
...
{{--                </li>--}}
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active  {{$categories1->name}}" id="{{$categories1->name}}" role="tabpanel" aria-labelledby="{{$categories1->name}}-tab">
                    <div class="mt-3 mb-3">
                        <div class="carousel slide multi-item-carousel" id="theCarousel">
                            <div class="carousel-inner row w-100 mx-auto">
