...
<style>
    ...
    .carousel_item_footer span.fa-star{
        color: orange;
    }
                        ...
                        <div class="carousel-inner" role="listbox">
                            ...
                            <div class="carousel-item active mb-2">
                                ...
                                @if(isset($latest1))
                                    ...
                                    <div class="card">
                                     <img class="card-img-top" src="{{asset('course/'. $latest1->thumbnail)}}" alt="Card image cap">
                                    </div>
                                            ...
                                            <div class="col carousel_item_footer main_bg_color" style="color: white">
                                                ...
                                                <div class="col float-left">
                                                    ...
                                                    <div class="col-3 col-sm-3">
                                                        <img class="card-img-top rounded-circle" src="https://mdbootstrap.com/img/Photos/Horizontal/Nature/4-col/img%20(18).jpg"
                                                            alt="Card image cap"> 
                                                    </div>
