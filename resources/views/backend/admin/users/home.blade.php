                                ...
                                @if($data)
                                    @foreach($data as $row)
                                        <tr>
                                            ...
                                            {{--                        <td>(171) 555-2222</td>--}}
                                            <td>
                                                <a href="{{route('edit_profile',['id'=>$row->id,'redirect'=>'user'])}}" data-id="{{$row->id}}" id="edit_cat"  class="edit" data-toggle=""><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
