...
Route::prefix('admin')->group(function (){
    ...
    Route::get('edit/category','Frontend\CategoryController@delete_category')->name('edit_category');
    Route::get('update/category','Frontend\CategoryController@delete_category')->name('update_category');
